...
namespace WebApp.Models
{
    ...
    public class ResponseModel<T>
    {
        ...
        public static ResponseModel<T> Fail(string Message, int result = (int)ResponseCode.InternalServerError, string RequestId = null, T data = default(T))
        {
        ...
        public static ResponseModel<T> Success(string Message, string RequestId = null, T data = default(T))
        {
            return new ResponseModel<T>()
            {
                Time = DateTime.UtcNow.Ticks,
